...
//
// ASCOM Switch hardware class for ShellyRelayController
//
...
namespace ASCOM.ShellyRelayController.Switch
{
    ...
    internal static class SwitchHardware
    {
        ...
        public static ArrayList SupportedActions
        {
            get
            {
                LogMessage("SupportedActions Get", "Returning List");
        ...
        public static string DriverInfo
        {
            get
            {
                ...
                string driverInfo = $"Shelly Relay Controller: Version: {version.Major}.{version.Minor}";
        ...
        public static string Name
        {
            ...
            get
            {
                string name = "Shelly Relay Controller";
        ...
        public static void SetSwitch(short id, bool state)
        {
            ...
            string jsnResponse = netIO.SendCommand(jsnRequest);
            JAPI.Switch.SetSwitchResponse.Response relayResponse = JsonConvert.DeserializeObject<JAPI.Switch.SetSwitchResponse.Response>(jsnResponse);
            if (relayResponse.error != null)
            {
        ...
        internal static double SwitchStep(short id)
        {
            ...
            LogMessage("SwitchStep", $"SwitchStep({id}" + " 1.0");
            return 1.0;
        }
        ...
        internal static double GetSwitchValue(short id)
        {
            ...
            string jsnResponse = netIO.SendCommand(jsnRequest);
            JAPI.Switch.GetStatusResponse.Response statusResponse = JsonConvert.DeserializeObject<JAPI.Switch.GetStatusResponse.Response>(jsnResponse);
            if (statusResponse.result.output == false)
                switchValue = 0.0;
            else
                switchValue = 1.0;
            LogMessage("GetSwitchValue", $"GetSwitchValue({id}" + $"Value {switchValue}");
            return switchValue;
        }
