...
//
// ASCOM Switch driver for ShellyRelayController
//
...
namespace ASCOM.ShellyRelayController.Switch
{
    ...
    //
    // Your driver's DeviceID is ASCOM.ShellyRelayController.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.ShellyRelayController.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _ShellyRelayController from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("102be87f-a982-4c81-9cc8-bf24fcbfb1bf")]
    [ProgId("ASCOM.ShellyRelayController.Switch")]
    [ServedClassName("ASCOM Switch Driver for ShellyRelayController")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV3, IDisposable
    {
        ...
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ShellyRelayController.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
